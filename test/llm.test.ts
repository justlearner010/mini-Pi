...
const tools = [{ name: "read_file", description: "Read", parameters: { type: "object" }, permission: "SAFE" as const, reason: "test-only safe tool", risk: "low", execute: async () => ({ content: "", isError: false }) }];
